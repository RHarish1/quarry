...
BLOCKED_PATH_KEYWORDS: set[str] = {
    ...
    "/account", "/auth", "/forgot-password", "/reset-password", "/profile",
    ...
    "/cart", "/checkout", "/add-to-cart", "/basket",  # E-commerce loops
    "/share", "/intent/",                             # Social sharing links
    "/wp-admin", "/wp-login",                         # WordPress admin paths
...
BLOCKED_FILE_EXTENSIONS: set[str] = {
    ...
    ".zip", ".rar", ".7z", ".tar", ".gz", ".exe", ".apk", ".dmg", ".iso", ".bin",

    # Audio & Video
    ".mp3", ".mp4", ".avi", ".mov", ".wav", ".ogg", ".flac", ".webm", ".mkv",
